...
parser.add_argument('--gpu', default='0,1,2', type=str, help='GPUs used for training')
...
def train(train_loader, network, criterion, optimizer, scaler):
    ...
    for batch in train_loader:
        ...
        with autocast(args.no_autocast):
            ...
            loss = criterion[0](output, target_img) + criterion[1](output, target_img, source_img)
...
if __name__ == '__main__':
    ...
    criterion.append(ContrastiveLoss())
    ...
    if not os.path.exists(os.path.join(save_dir, args.model + '.pth')):
        ...
        for epoch in tqdm(range(setting['epochs'] + 1)):
            ...
            if epoch % setting['eval_freq'] == 0:
                ...
                print("Epoch ", epoch, ":    avg_pnsr: ", avg_psnr, "\n")

    else:
        print('==> Existing trained model')
        exit(1)
    # print('==> Resume training, current model name: ' + args.model)
    # # print(network)
    #
    # writer = SummaryWriter(log_dir=os.path.join(args.log_dir, args.exp, args.model))
    #
