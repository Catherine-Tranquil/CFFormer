...
# from .dehazeformer import PatchEmbed
# Reference:
...
class DyHeadBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self._init_weights()
        self.palayer = PALayer(channels=96)
...
class DyHead(BaseModule):
    ...
    def __init__(self,
        ...
        self.patch_merge1 = PatchEmbed(
            patch_size=4, in_chans=96, embed_dim=96)
        self.patch_merge2 = PatchEmbed(
            patch_size=2, in_chans=96, embed_dim=96)
        self.palayer = PALayer(channels=96)
    ...
    def forward(self, inputs):
        ...
        outs[0] = self.patch_merge1(outs[0])
        outs[1] = self.patch_merge2(outs[1])
        outs[2] += outs[0] + outs[1]
        # outs[2] = self.palayer(outs[2])
        return outs[2]
